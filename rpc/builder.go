...
func NewRPCMessageBuilder(from string, codec Codec, fromID string) *RPCMessageBuilder {
...
func (b *RPCMessageBuilder) SetSignature(sign crypto.Signature) *RPCMessageBuilder {
	b.signature = sign
	return b
}
...
func (b *MessageBuilder) SetData(data []byte) *MessageBuilder {
	b.data = data
	return b
}
